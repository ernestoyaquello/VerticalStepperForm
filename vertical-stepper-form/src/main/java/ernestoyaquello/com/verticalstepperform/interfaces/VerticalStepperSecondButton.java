...
public interface VerticalStepperSecondButton {
     ...
     * button can be added via {@link ernestoyaquello.com.verticalstepperform.VerticalStepperFormLayout.Builder#addSecondButtonLastStep(String) addSecondButtonLastStep}
     */
